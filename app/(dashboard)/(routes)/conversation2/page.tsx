        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="flex flex-col-reverse gap-4">
            {messages.map((message, index) => (
              <div className={
                cn("whitespace-pre-wrap p-8 w-full flex items-start gap-x-8 rounded-lg break-keep ", message.role === 'user' ? "bg-white border border-black/10" : "bg-muted justify-between")}
                key={index} >
